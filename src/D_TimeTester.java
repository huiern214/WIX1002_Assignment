...
//Question D (v2 - 461.52 minutes)
public class D_TimeTester {
    public static void main(String[] args) {
        ...
        try{
            BufferedReader reader = new BufferedReader(new FileReader("./src/extracted_log"));
            ...
            System.out.printf("Average execution time: %.2f minutes", (totalTime/numOfJob));
            reader.close();
